...
static s_loraParameter_t loraParam= { F_868MHz, EMISSION_POWER, BW_125kHz, SF_12, 4, 0, 0};
//static s_loraParameter_t loraParam_lna= { F_868MHz, EMISSION_POWER, BW_125kHz, SF_12, 4, 1, 0};
...
ATEerror_t TST_get_lora_config(const char *buf, unsigned bufSize)
{
  ...
  AT_PRINTF("%d:%d:%d:%d:4/%d:%d:%d\r\n",  loraParam.freqMHz, loraParam.power, bwSet[loraParam.bandwidth], \
